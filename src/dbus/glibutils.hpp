...
template <typename T>
inline const char *GetDBusDataType();

template <>
inline const char *GetDBusDataType<uint32_t>()
{
    return "u";
}
...
template <>
inline const char *GetDBusDataType<uint16_t>()
{
    return "q";
}

template <>
inline const char *GetDBusDataType<int16_t>()
{
    return "n";
}

template <>
inline const char *GetDBusDataType<uint64_t>()
{
    return "t";
}

template <>
inline const char *GetDBusDataType<int64_t>()
{
    return "x";
}

template <>
inline const char *GetDBusDataType<double>()
{
    return "d";
}

template <>
inline const char *GetDBusDataType<bool>()
{
    return "b";
}

template <>
inline const char *GetDBusDataType<std::string>()
{
    return "s";
}
...
// Declare template as prototype only so it cannot be used directly
template <typename T>
inline T GetVariantValue(GVariant *v);

template <>
inline uint32_t GetVariantValue<uint32_t>(GVariant *v)
{
...
template <>
inline uint16_t GetVariantValue<uint16_t>(GVariant *v)
{
    return g_variant_get_uint16(v);
}

template <>
inline int16_t GetVariantValue<int16_t>(GVariant *v)
{
    return g_variant_get_int16(v);
}

template <>
inline uint64_t GetVariantValue<uint64_t>(GVariant *v)
{
    return g_variant_get_uint64(v);
}

template <>
inline int64_t GetVariantValue<int64_t>(GVariant *v)
{
    return g_variant_get_int64(v);
}

template <>
inline bool GetVariantValue<bool>(GVariant *v)
{
    return g_variant_get_boolean(v);
}

template <>
inline std::string GetVariantValue<std::string>(GVariant *v)
{
    gsize size = 0;
 ...
 */
template <typename T>
inline GVariant *CreateVariantValue(const char *dbustype, T value)
{
    return g_variant_new(dbustype, value);
}

template <>
inline GVariant *CreateVariantValue(const char *dbustype, std::string value)
{
    return g_variant_new(dbustype, value.c_str());
}

template <typename T>
inline GVariant *CreateVariantValue(T value)
{
    return g_variant_new(GetDBusDataType<T>(), value);
}

template <>
inline GVariant *CreateVariantValue(std::string value)
{
 ...
 */
template <typename T>
inline GVariant *GVariantFromVector(const std::vector<T> input)
{
 ...
 */
template <typename T>
inline GVariant *GVariantTupleFromVector(const std::vector<T> input)
{
    GVariantBuilder *bld = GVariantBuilderFromVector(input);
 ...
 */
inline void checkParams(const char *func, GVariant *params, const char *format, unsigned int num = 0)
{
    std::string typestr = std::string(g_variant_get_type_string(params));
    if (format != typestr || (num > 0 && num != g_variant_n_children(params)))
    {
        THROW_DBUSEXCEPTION(func, "Incorrect parameter format: " + typestr + ", expected " + format + "(elements expected: " + std::to_string(num) + " received: " + std::to_string(g_variant_n_children(params)) + ")");
    }
}
...
// Declare template as prototype only so it cannot be used directly
template <typename T>
inline T ExtractValue(GVariant *v, int elm);

template <>
inline uint64_t ExtractValue<uint64_t>(GVariant *v, int elm)
{
    return g_variant_get_uint64(g_variant_get_child_value(v, elm));
}

template <>
inline int64_t ExtractValue<int64_t>(GVariant *v, int elm)
{
    return g_variant_get_int64(g_variant_get_child_value(v, elm));
}

template <>
inline uint32_t ExtractValue<uint32_t>(GVariant *v, int elm)
{
    return g_variant_get_uint32(g_variant_get_child_value(v, elm));
}

template <>
inline int32_t ExtractValue<int32_t>(GVariant *v, int elm)
{
    return g_variant_get_int32(g_variant_get_child_value(v, elm));
}

template <>
inline uint16_t ExtractValue<uint16_t>(GVariant *v, int elm)
{
    return g_variant_get_uint16(g_variant_get_child_value(v, elm));
}

template <>
inline int16_t ExtractValue<int16_t>(GVariant *v, int elm)
{
    return g_variant_get_int16(g_variant_get_child_value(v, elm));
}

template <>
inline bool ExtractValue<bool>(GVariant *v, int elm)
{
    return g_variant_get_boolean(g_variant_get_child_value(v, elm));
}

template <>
inline std::string ExtractValue<std::string>(GVariant *v, int elm)
{
